...
const URL$2 = `http://${url$2}/${entryPoint$2}`;
...
const url$4 = 'https://6c46-168-176-40-138.ngrok.io';
const entryPoint$4 = 'users';

const URL$4 = `http://${url$4}/${entryPoint$4}`;
const crear$1 ="users"; 
const resolvers$4 = {
	Query: {
		allusers: (_) =>
	...
	Mutation: {
		createuser: (_, { UserNoId }) =>
			generalRequest(`${URL$4}/${crear$1}`, 'POST', UserNoId),
		userlogIn: (_, { LogIn }) =>
			generalRequest(`${URL$4}/login`, 'POST', LogIn)
	}
};
